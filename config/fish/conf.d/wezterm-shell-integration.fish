# Enable shell integration for wezterm, since it doesn't work by default when using starship
# https://github.com/wez/wezterm/issues/115
# https://github.com/PerBothner/DomTerm/blob/master/tools/shell-integration.fish
if not status is-interactive; or not string match -q "$TERM_PROGRAM" "WezTerm"
  exit
end
